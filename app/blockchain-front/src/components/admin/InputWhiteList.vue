    ...
    <div class="container py-2">
        <div class="row my-4">
            ...
            <div class="col-4 d-grid my-auto">
                <button class="btn btn-primary btn-block buttonSave" id="buttonSave" v-on:click="add">Add to list
                </button>
            </div>
        </div>
        <div class="row my-4 AddList">
            <table class="table" id="myTable">
                <tr v-for="item in reactiveData">
                    ...
                    <td style="width: 20%;">
                        <button class="btn btn-outline-danger " v-on:click="deleteRow(reactiveData.indexOf(item))">
                            Delete
                        </button>
                    </td>
                </tr>
        ...
        <div class="row justify-content-center">
            <button class="btn btn-primary" v-on:click="emit('startProposal', reactiveData)">Start proposal session
            </button>
        </div>
    </div>
</template>
